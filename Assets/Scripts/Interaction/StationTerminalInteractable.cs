...
/// <summary>
/// Reusable scene entry point for station terminal modules.
/// The actual mini-game UI can replace panelRoot without changing PlayerInteractor.
/// </summary>
public class StationTerminalInteractable : MonoBehaviour, IInteractable
{
    [SerializeField] private string interactionPrompt = "操作 终端";
